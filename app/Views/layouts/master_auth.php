                    ...
                    <div class="header-top-left">
                        <div class="header-top-contact">
                            <ul>
                                ...
                                <li><a
                                        href="https://live.themewild.com/cdn-cgi/l/email-protection#50393e363f103528313d203c357e333f3d"><i
                                            class="far fa-envelopes"></i> <span class="__cf_email__"
                                            data-cfemail="244d4a424b64415c45495448410a474b49">[email&#160;protected]</span></a>
                                </li>
                    ...
                    <div class="collapse navbar-collapse" id="main_nav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu fade-down">
                                    <li><a class="dropdown-item" href="project.html">Projects One</a></li>
                                    <li><a class="dropdown-item" href="project-2.html">Projects Two</a></li>
                                    <li><a class="dropdown-item" href="project-single.html">Project Single</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                        ...
                        <div class="nav-right">
                            ...
                            <div class="nav-right-btn mt-2">
                                <a href="#" class="theme-btn">Get A Quote<i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-5 mx-auto">
                    <div class="login-form">
                        <div class="login-header">
                            ...
                            <p>Login with your aquax account</p>
                        </div>
                        <form action="#">
                            <div class="form-group">
                ...
                <div class="row footer-widget-wrapper pt-100 pb-70">
                    <div class="col-md-6 col-lg-4">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a
                                        href="https://live.themewild.com/cdn-cgi/l/email-protection#bbd2d5ddd4fbdec3dad6cbd7de95d8d4d6"><i
                                            class="far fa-envelope"></i><span class="__cf_email__"
                                            data-cfemail="375e59515877524f565a475b521954585a">[email&#160;protected]</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box list">
                            ...
                            <ul class="footer-list">
                                <li><a href="#"><i class="fas fa-caret-right"></i> Prawn Feeds</a></li>
                                <li><a href="#"><i class="fas fa-caret-right"></i> Flowerhorn Fish</a></li>
                                <li><a href="#"><i class="fas fa-caret-right"></i> Hatchery Supply</a></li>
                                <li><a href="#"><i class="fas fa-caret-right"></i> Aquatic Plants</a></li>
                                <li><a href="#"><i class="fas fa-caret-right"></i> Green Care</a></li>
                                <li><a href="#"><i class="fas fa-caret-right"></i> Water Changes</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                ...
                <div class="row">
                    <div class="col-md-6 align-self-center">
                        <p class="copyright-text">
                            &copy; Copyright <span id="date"></span> <a href="#"> Aquax </a> All Rights Reserved.
                        </p>
                    </div>
                    <div class="col-md-6 align-self-center">
